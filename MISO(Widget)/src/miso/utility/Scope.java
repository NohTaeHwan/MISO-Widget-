...
public class Scope {
	...
	public JFXRadioButton getEngRadioButton() {
		return engRadioButton;
	}

	public void setEngRadioButton(JFXRadioButton engRadioButton) {
		this.engRadioButton = engRadioButton;
	}

	public JFXRadioButton getKorRadioButton() {
		return korRadioButton;
	}

	public void setKorRadioButton(JFXRadioButton korRadioButton) {
		this.korRadioButton = korRadioButton;
	}
