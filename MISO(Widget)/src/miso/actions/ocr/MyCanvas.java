...
public class MyCanvas extends Canvas {
   ...
   public MyCanvas() {
      ...
      this.setWidth(com.sun.glass.ui.Screen.getMainScreen().getWidth());
      this.setHeight(com.sun.glass.ui.Screen.getMainScreen().getHeight());
      ...
      Platform.runLater(new Runnable() {
         ...
         public void run() {
            ...
            if (capture.getArea() > 100) {
               ...
               gc.clearRect(0, 0, com.sun.glass.ui.Screen.getMainScreen().getWidth(), com.sun.glass.ui.Screen.getMainScreen().getHeight());
